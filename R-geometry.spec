...
Version  : 0.5.1
Release  : 64
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/geometry_0.5.1.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/geometry_0.5.1.tar.gz
Summary  : Mesh Generation and Surface Tessellation
Group    : Development/Tools
License  : GPL-3.0 Qhull
Requires: R-geometry-lib = %{version}-%{release}
Requires: R-geometry-license = %{version}-%{release}
Requires: R-Rcpp
...
%package license
Summary: license components for the R-geometry package.
Group: Default

%description license
license components for the R-geometry package.


%prep
%setup -q -n geometry
pushd ..
cp -a geometry buildavx2
popd
pushd ..
cp -a geometry buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738186361

%install
export SOURCE_DATE_EPOCH=1738186361
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/R-geometry
cp %{_builddir}/geometry/inst/doc/qhull/COPYING.txt %{buildroot}/usr/share/package-licenses/R-geometry/1355101d73a0015d7c5d2b691b4435386e655a9d || :
cp %{_builddir}/geometry/vignettes/qhull/COPYING.txt %{buildroot}/usr/share/package-licenses/R-geometry/1355101d73a0015d7c5d2b691b4435386e655a9d || :
LANG=C.UTF-8
...
/usr/lib64/R/library/geometry/extdata/issue57-tsearch.RData
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/geometry/libs/geometry.so
/V4/usr/lib64/R/library/geometry/libs/geometry.so
/usr/lib64/R/library/geometry/libs/geometry.so

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/R-geometry/1355101d73a0015d7c5d2b691b4435386e655a9d
